        ...
        <div className='head'>
            ...
            <div className='wrapper-head'>
                <div className='item-head-02'>
                    <div>
                        ...
                        <div>
                            ...
                            &nbsp;и&nbsp;
                            <span className='colorbonus'>
                                <span className='fontsize'>{bonusbalans}Б</span>
                                &nbsp;баллов
                            </span>
                        </div>
                    </div>
                    <div>
                        <div>скидка</div>
                        <div>
                            <span className='fontsize'>{sale}%</span>
                        </div>
                    </div>
                </div>
                ...
                <div className='item-head-04'>
                    в&nbsp;коллекции
                    <div>
                        <span className='fontsize'>{collection_to}</span>
                        &nbsp;из&nbsp;
                        <span className='fontsize'>{collection_max}</span>&nbsp;
                        <span className='fontdecor'>рецептов</span>
                    </div>
                </div>
                <div className='item-head-05'>
                    выполнено
                    <div>
                        <span className='fontsize'>{tasks_to}</span>
                        &nbsp;из&nbsp;
                        <span className='fontsize'>{tasks_max}</span>&nbsp;
                        <span className='fontdecor'>заданий</span>
                    </div>
                </div>
